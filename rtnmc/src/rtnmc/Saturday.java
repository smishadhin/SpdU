...
//  System.out.println(timeRow.getCell(cl2-1));
 ...
 teacherIniString = "none";
                                     ...
                                     //   String teacherIniString = teacher.toString();
                                       ...
                                       // System.out.println( insert.mcinserBiodata(day, courseCodenew, teacherIniString, classTime, roomNo));
                                        System.out.println(day + " (---)" + courseCodenew + " (---) " + teacherIniString + " (---) " + classTime + " (---) " + roomNo);
                                    }

                                    if (cell1.getStringCellValue().equals("Sunday")||cell1.getStringCellValue().equals("Lab (Electrical Circuit, Digital Electronics, Electronic Devices and Circuits)")) {
                                        a = true;
                                    }
                                }
                            }
