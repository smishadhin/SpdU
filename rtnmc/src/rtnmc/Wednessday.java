...
public class Wednessday {
    ...
    public void wednessday(String courseCode, File file) throws Exception {
...
//  System.out.println(timeRow.getCell(cl2-1));
 ...
 teacherIniString = "none";
                                    ...
                                    if (cell1.getStringCellValue().equals("Thursday")||cell1.getStringCellValue().equals("Lab (Electrical Circuit, Digital Electronics, Electronic Devices and Circuits)")) {
                                        a = true;
                                    }
                                }
                            }
