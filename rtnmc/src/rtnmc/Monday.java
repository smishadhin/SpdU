...
public class Monday {
    ...
    public void monday(String courseCode, File file) throws Exception {
...
//  System.out.println(timeRow.getCell(cl2-1));
                                    ...
                                    if (cell1.getStringCellValue().equals("Tuesday") || cell1.getStringCellValue().equals("Lab (Electrical Circuit, Digital Electronics, Electronic Devices and Circuits)")) {
                                        a = true;
                                    }
                                }
                            }
