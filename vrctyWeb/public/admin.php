...
<div style="width: 100%">
    <section style="float: left;width: 50%">
        <div align="center" style="margin: 10%">
            ...
            $collectInfoquery = "SELECT title,firstname,lastname,initial,department,faculty,campus,mode,designation,emid,email,mobile FROM users WHERE id={$useradmin};";
            ...
            <article role="article">
                ...
                <aside role="complementary" class="languages">
                    ...
                    <div id="tabContainer">
                        <div id="tabs">
                            <ul>
                                <li id="tab1"><a href="#tabPanel1">Notifications</a></li>
                                <li id="tab2"><a href="#tabPanel2">Edit Profile</a></li>
                                <li id="tab3"><a href="#download">Download</a></li>
                            </ul>
                        </div>
                        <div id="containers">
                            <div id="tabPanel1">
...
<p><img src=\"{$img}\"  style='width:204px;height:128px;border-radius: 50%;'></p>";*/
                                    ...
                                    <section>
                                        ...
                                        <form action="updateprofile.php?id=<?php echo $useradmin;?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <p><img src="<?php echo $img;?>"  style='width:204px;height:128px;border-radius: 50%;'></p>
                                        <p><label>Select Your
                                                Image</label>
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control text_input" name="firstName" value="<?php echo $tcfirstname; ?>"
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control text_input" name="lastName" value="<?php echo $tclastname; ?>"
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control text_input"  value="<?php echo $tcinitial; ?>"
                                                           name="teacherInitial"
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control text_input"
                                                           name="emid"
                                                           placeholder="DIU Employe ID"/><?php echo $tcemid; ?><?php /*echo $erremid */ ?>

                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <input type="email" class="form-control text_input" value="<?php echo $tcemail; ?>"
                                                           name="email"
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control text_input" value="<?php echo $tcmobile; ?>"
                                                           name="mobile"
